...
graph .graph -leftmargin $leftMargin -rightmargin $rightMargin -width 600 -height 400
...
proc LogicPlot {from graph args} {
    ...
    if {![winfo exists $graph]} {
        ...
        graph $graph -title {} -topmargin 1 -bottommargin 1 -height 0.75i -plotpadx 4 -plotpady 8 -bd 0\
