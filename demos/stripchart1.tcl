...
foreach sym {square circle diamond plus cross triangle} {
    .mbar.prefs.wm add radiobutton -label $sym -variable warningsym -value $sym -state disabled\
            -command {.sc pen configure warning -symbol $warningsym}
    .mbar.prefs.em add radiobutton -label $sym -variable errorsym -value $sym -state disabled\
