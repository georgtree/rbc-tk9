...
#ifndef _RBCVECTORINT
#define _RBCVECTORINT
...
#define VECTOR_CHAR(c) ((isalnum(UCHAR(c))) || (c == '_') || (c == ':') || (c == '@') || (c == '.'))
...
struct Rbc_Vector_s {
     ...
     *
     * -1 means that no finite extremum is currently cached.
     */
    Tcl_Size minIndex;
    Tcl_Size maxIndex;
...
int Rbc_ComplexIsZero(Rbc_Complex value);
