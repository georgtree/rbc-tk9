...
int Rbc_GetPen (Graph *graphPtr, const char *name,
...
int Rbc_ElementOp (Graph *graphPtr, Tcl_Interp *interp, int objc,
    Tcl_Obj *const objv[], Rbc_Uid classUid);
int Rbc_GridOp (Graph *graphPtr, Tcl_Interp *interp, int objc,
    Tcl_Obj *const objv[]);
int Rbc_CrosshairsOp (Graph *graphPtr, Tcl_Interp *interp, int objc,
    Tcl_Obj *const objv[]);
int Rbc_MarkerOp (Graph *graphPtr, Tcl_Interp *interp, int objc,
    Tcl_Obj *const objv[]);
int Rbc_PenOp (Graph *graphPtr, Tcl_Interp *interp, int objc,
    Tcl_Obj *const objv[]);
